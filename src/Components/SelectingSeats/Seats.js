...
export default function Seats() {
    ...
    const seatDesign=()=>
    {
         for(let i=0 ;i < InoxSeats.length ;i++)
         {
            ...
            seatID.push({SeatNo:InoxSeats[i].seatId,Blocked:Blocked})
  ...
  return (
    <div className='Seats-page'>
      {/* noOfSeats={noOfSeats} NoOfTickets={noOfTickets}  noOfTickets={3}*/}
      <br/>
      <h3 className='animate-charcter'>Select Seats</h3> <br/>
      <div className={freezeState.class}>{freezeState.msg}  </div>
      <div className='seats'>
      <SeatComponent seatID={seatID} blockedSeats={blockedSeats} setUserSeatSelection={setUserSeatSelection} setFreezeState={setFreezeState} noOfSeats={noOfSeats} noOfTickets={noOfTickets} noOfRows={noofRows}  />
      </div>
